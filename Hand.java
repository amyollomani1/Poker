...
public class Hand {
   ...
   private void buildSuitFrequencyMap() {
   ...
   public boolean isFourOfaKind() {
      ...
      /* YOUR CODE HERE - IMPLEMENT THIS METHOD */
	   ...
	   if(rankFrequency.containsValue(4)) return true;
	   else return false;
   }

   // Is this hand a full house (3 cards of the same rank & 2 cards of the same rank)?
   public boolean isFullHouse() {
	   if(rankFrequency.containsValue(3) && rankFrequency.containsValue(2)) return true;
   ...
   public boolean isFlush() {
      /* YOUR CODE HERE - IMPLEMENT THIS METHOD */
	   ...
	   for(int i = 0; i<hand.size(); i++) {
		   if(hand.get(0).getSuit() != (hand.get(i).getSuit())) return false;
	   }
   ...
   public boolean isThreeOfaKind() {
      /* YOUR CODE HERE - IMPLEMENT THIS METHOD */
	   if(rankFrequency.containsValue(3)&& !rankFrequency.containsValue(2)) return true;
	   else return false; // delete this line and substitute it with your code
   }

   // Does this hand contain exactly two pairs?
   public boolean isTwoPair() {
      /* YOUR CODE HERE - IMPLEMENT THIS METHOD */
	   Set<Integer> union = rankFrequency.keySet();
